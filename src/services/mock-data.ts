...
export const mockMovies: Movie[] = [
  ...
  },
  {
    ...
    country: [{ id: '1', name: 'Mỹ', slug: 'my' }],
    actor: ['Sam Worthington', 'Zoe Saldana', 'Sigourney Weaver', 'Kate Winslet'],
    director: ['James Cameron'],
  },
  {
    id: '3',
    ...
    country: [{ id: '1', name: 'Mỹ', slug: 'my' }],
    actor: ['Noah Ringer', 'Dev Patel', 'Nicola Peltz'],
  ...
  },
  {
    ...
    year: 1968,
    thumb_url:
      'https://m.media-amazon.com/images/M/MV5BZTFkZjYxNWItZmE2MC00MGE4LWIxYTgtZmIzOWM1YmVkYjc0XkEyXkFqcGdeQXVyMDUyOTUyNQ@@._V1_.jpg',
    poster_url:
      'https://m.media-amazon.com/images/M/MV5BZTFkZjYxNWItZmE2MC00MGE4LWIxYTgtZmIzOWM1YmVkYjc0XkEyXkFqcGdeQXVyMDUyOTUyNQ@@._V1_.jpg',
    ...
    country: [{ id: '1', name: 'Mỹ', slug: 'my' }],
    actor: ['Eric Porter', 'Hildegard Knef', 'Suzanna Leigh'],
  ...
  },
  {
    ...
    year: 2018,
    thumb_url:
      'https://m.media-amazon.com/images/M/MV5BMGE1ZGJlMDAtZTNmYy00MGEyLWJmOWUtMjc5ZWZlZDU2M2I1XkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg',
    poster_url:
      'https://m.media-amazon.com/images/M/MV5BMGE1ZGJlMDAtZTNmYy00MGEyLWJmOWUtMjc5ZWZlZDU2M2I1XkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg',
    content:
    ...
    country: [{ id: '2', name: 'Anh', slug: 'anh' }],
    actor: ['Michaela Coel', 'John Goodman', 'Harriet Walter'],
    director: ['Hugo Blick'],
  },
];

// Mock search function
export function mockSearchMovies(
  keyword: string,
  page: number = 1,
  limit: number = 20
